                                        ...
                                        <div className="col-md-12">
                                            <div style={{display:"flex"}}>
                                                <Button color="primary" style={{textTransform:"none"}}
                                                        onClick={() => this.props.history.push("/sso/extern/"+this.props.match.params.key + "/" + this.props.match.params.auth )}>Se connecter à un compte existant</Button>
...
export default withSnackbar(extern_signup);
