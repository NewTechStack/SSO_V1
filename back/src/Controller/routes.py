...
def setuproute(app, call):
    ...
    @app.route('/extern/key',                   ['OPTIONS', 'GET'],         lambda x = None: call([check_key, user_get_key])) #done
    @app.route('/extern/key/<>/token',          ['OPTIONS', 'POST'],        lambda x = None: call([check_key, user_wait_token])) #done
